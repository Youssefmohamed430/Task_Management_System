...
namespace Task_Management_System
{
    public class RepositryTasks
    {
        ...
        => _tasks = new SortedDictionary<int, List<Task>>
        {
            ...
            { 107 , new List<Task> { new Task { _Title = "SEO Optimization", _Description = "Optimize the company website for search engines", _status = Status.Completed } } },
            { 108 , new List<Task> { new Task { _Title = "Fix UI Bugs", _Description = "Resolve reported issues in the user interface", _status = Status.Completed }, new Task { _Title = "User Testing", _Description = "Conduct user testing for the new mobile app", _status = Status.InProgress }  } },
